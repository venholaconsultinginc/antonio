...
| <img src="icon-empty.svg" width="56" alt=""> | Empty | Full schema, zero rows — a blank starting point<br>129 tables (Cordelia's full schema) | [`cordelia-sample-empty.sqlite`](../example-data/cordelia-sample-empty.sqlite) |
